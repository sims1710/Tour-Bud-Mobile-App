...
public class TouristMap extends AppCompatActivity implements GoogleMap.OnInfoWindowClickListener, OnMapReadyCallback, OnMapsSdkInitializedCallback{
    private static final String TAG = TouristMap.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapTourist);
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        Intent myIntent = new Intent(TouristMap.this, ViewTour.class);
        myIntent.putExtra("tourId", tourId); //Optional parameters
        TouristMap.this.startActivity(myIntent);
